...
import { CalendarDays, Users, CheckCircle2, Briefcase, MapPin, AlertTriangle, Loader2 } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        <div>
          ...
          <p className="text-[13px] text-gray-500">
            Monthly team attendance overview, submission rates, and daily breakdowns.
          </p>
        </div>
      </div>
                  ...
                  {detailLoading ? (
                    ...
                    <div className="space-y-2">
                      {dayDetail.map((member) => {
                        ...
                        return (
                          <div key={member.id} className="flex items-center gap-3 p-2.5 rounded-xl bg-gray-50/80 hover:bg-gray-100/80 transition-colors">
